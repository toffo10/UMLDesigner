...
public class UmlDesignerParser extends Parser {
	...
	// D:\\Code\\UMLDesigner\\src\\main\\code\\compiler\\generated\\UmlDesigner.g:108:1: classRelations returns [List<Pair> classList] : i= ID c= cardinality ( COMMA i1= ID c1= cardinality )* ;
	public final List<Pair> classRelations() throws RecognitionException {
		...
		try {
			// D:\\Code\\UMLDesigner\\src\\main\\code\\compiler\\generated\\UmlDesigner.g:110:5: (i= ID c= cardinality ( COMMA i1= ID c1= cardinality )* )
			// D:\\Code\\UMLDesigner\\src\\main\\code\\compiler\\generated\\UmlDesigner.g:110:8: i= ID c= cardinality ( COMMA i1= ID c1= cardinality )*
			{
			...
			// D:\\Code\\UMLDesigner\\src\\main\\code\\compiler\\generated\\UmlDesigner.g:111:7: ( COMMA i1= ID c1= cardinality )*
			loop18:
			while (true) {
				int alt18=2;
				...
				switch (alt18) {
				case 1 :
					// D:\\Code\\UMLDesigner\\src\\main\\code\\compiler\\generated\\UmlDesigner.g:111:8: COMMA i1= ID c1= cardinality
					{
